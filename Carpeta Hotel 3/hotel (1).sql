...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-02-2026 a las 15:57:12
...
(1, 7, 4, '2026-02-24', 'Nada a notar.'),
(2, 1, 2, '2026-02-22', 'Nada a notar.'),
(3, 5, 3, '2026-03-01', 'Nada a notar.'),
(4, 10, 5, '2026-02-26', 'Nada a notar.'),
(5, 1, 1, '2026-02-24', 'Nada a notar.');
...
(1, 'Fernando', '6767676767', 'fernandito4567@gmail.com', '2026-02-02'),
(2, 'Nicolas', '4328769021', 'nicolascaja@gmail.com', '2026-02-08'),
(3, 'Gilberto', '5546789182', 'milberto123@gmail.com', '2026-02-14'),
(4, 'Calamarino', '7777777777', 'calamarino.elegante@gmail.com', '2026-02-07'),
(5, 'Patricio', '1111111111', 'patrisioeztrela@gmail.com', '2026-02-16');
...
(1, 1, 'Juanito', 'Recepcionista', 'xxjuanitogamerxx@gmail.com'),
(2, 1, 'Pepe', 'Chef', 'elpepe123@gmail.com'),
(3, 2, 'Jeff', 'Personal de mantenimiento', 'eljeffekisde@gmail.com'),
(4, 2, 'Don Juan', 'Personal de mantenimiento', 'dedonjuan432@gmail.com'),
(5, 3, 'Alberto', 'Personal de limpieza', 'albertonimo@gmail.com');
...
(1, 1, 1, 'Regular', 1000, 'Ocupada'),
(2, 1, 101, 'Doble', 2500, 'Vacante'),
(3, 2, 301, 'Doble', 3500, 'Vacante'),
(4, 2, 401, 'Suite', 6000, 'Ocupada'),
(5, 3, 101, 'Regular', 800, 'Ocupada');
...
(1, 'Hotel Karma', 'Culiacán', '6679996767'),
(2, 'Hotel el Venao', 'Tijuana', '6634229191'),
(3, 'Hotel Tilin', 'Guadalajara', '4124127878');
...
(1, 1, '2026-02-17', 12000, 'Tarjeta', '6513', 'Aprovado'),
(2, 3, '2026-02-20', 12000, 'Tarjeta', '1244', 'Aprovado'),
(3, 5, '2026-02-15', 10000, 'Tarjeta', '1241', 'Aprovado'),
(4, 7, '2026-02-01', 100000, 'Efectivo', '9839', 'Aprovado'),
(5, 9, '2026-02-23', 2000, 'Paypal', '9999', 'Aprovado');
...
(1, 1, 1, '2026-02-19', '2026-02-23', '1', 'Vigente', '2026-02-18'),
(2, 1, 1, '2026-02-28', '2026-03-03', '1', 'Vigente', '2026-02-18'),
(3, 2, 2, '2026-02-21', '2026-02-24', '1', 'Vigente', '2026-02-18'),
(4, 2, 2, '2026-02-26', '2026-03-02', '1', 'Vigente', '2026-02-18'),
(5, 3, 3, '2026-03-01', '2026-03-05', '2', 'Vigente', '2026-02-18'),
(6, 3, 3, '2026-03-09', '2026-03-16', '2', 'Vigente', '2026-02-18'),
(7, 4, 4, '2026-02-22', '2026-02-26', '1', 'Vigente', '2026-02-18'),
(8, 4, 4, '2026-03-03', '2026-03-11', '1', 'Vigente', '2026-02-18'),
(9, 5, 5, '2026-02-21', '2026-02-25', '2', 'Vigente', '2026-02-18'),
(10, 5, 5, '2026-03-02', '2026-03-09', '2', 'Vigente', '2026-02-18');
...
(1, 'Spa', 3500),
(2, 'Restaurante', 600),
(3, 'Servicio a habitación', 400),
(4, 'Actividades', 1000),
(5, 'Limpieza a habitación', 700);
...
ALTER TABLE `reserva`
  ...
  ADD CONSTRAINT `reserva_ibfk_2` FOREIGN KEY (`id_cliente`) REFERENCES `clientes` (`id_cliente`);
